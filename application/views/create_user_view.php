    ...
    <div class="row">    
        ...
        ?>       
    			<div class='form form-horizontal'>  
                  ...
                  <select name='fullname' value= "<?php echo set_value('fullname');?>" class='form-control' data-validation='required'>
                  <option value="">---please select employee---</option>
<?php                $result =   $this->db->get('employee');
 ...
 ?>
	                    ...
	                    <div class="form-group">
                          ...
                          <div class='col-sm-2'>
                               <input type='button' class='form-control btn btn-primary'  onclick='showModal()' value='More Position'>
                          </div>  
	                    </div>
	                    <div class="form-group">
