...
<div class="container">
    <div class="row">
        <div class="under_line">
            <h3><i class='fa fa-user-plus'></i> Categories </h3>
        </div>
    </div>
   <?php   
    ...
    <div class="row">    
        <div class="panel panel-default">
            <div class='panel-heading'>
                <h3 class='panel-title'><strong> <i class='fa fa-user'></i> Categories View</strong></h3>
            </div>              
...
$(document).ready(function() {
  $('#example').dataTable( {
      "processing": true,
      "serverSide": true,
      "ajax": "<?php echo base_url();?>sale/server_side",
      "columns": [           
            { "data": "name" },
            { "data": "description" },
            { "data":"id"}           
