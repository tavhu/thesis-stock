    ...
    <div class="row">    
        <div class="panel panel-default">
            <div class='panel-heading'>
                <h3 class='panel-title'><strong> <i class='fa fa-user'></i> Supplier View</strong></h3>
            </div>              
...
$(document).ready(function() {
  $('#example').dataTable( {
      "processing": true,
      "serverSide": true,
      "ajax": "<?php echo base_url();?>supplier/server_side",
      "columns": [           
            { "data": "companyname" },
            { "data": "name" },
            { "data": "telephone1" },
      ...
      $("#deleteButton").click(
          function(){
             ...
             var post_data = {       
                      ...
                      jQuery.ajax({
                          type: "POST",
                          url: "<?php echo base_url(); ?>supplier/deleteUser",
                          data: post_data,                 
